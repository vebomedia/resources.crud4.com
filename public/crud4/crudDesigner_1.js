        ...
        if (key === 'field_name') {
            ...
            $return += `
                <div class="input-group mb-2">
                    ...
                    + htmlSelect('field_name', $tableFields, field_name, `class="form-control portletInput virtualField" data-portletno="` + porletNo + `"`)
                    + `</div>`;
        } 
...
function dividerArea(groupData) {
    ...
    var $return = ` 
                        <li class="mt-2 p-2 shadow bg-white rounded groupContainer _callbackGroup">
...
function scriptArea(groupData) {
    ...
    return `<li class="mt-2 p-2 shadow bg-white rounded groupContainer _callbackGroup">
...
function fieldArea(groupData) {
    ...
    var $return = `
                        <li class="mt-2 p-2 shadow bg-white rounded groupContainer _callbackGroup fieldAreaColor">
    ...
    $.each(groupColumns, function (key, porlets) {
        ...
        $return += `<div class="col column m-1 p-2 _callbackColumnClicked">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $(document).on('change', '.virtualField', function () {
